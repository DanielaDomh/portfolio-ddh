    ...
    <div className="container-projects">
      ...
      <article id="project" className="projects">
        <div className="project-box">
          ...
          <a
            href="https://github.com/DanielaDomh/Rick-and-Morty-Characters"
            target="_blank"
          >
            Ver Código
          </a>
        ...
        <div className="project-box">
          ...
          <a href="https://github.com/DanielaDomh/pokeapi" target="_blank">
            Ver Código
          </a>
        </div>
        ...
        <div className="project-box">
          ...
          <a href="https://e-commerce-gen25-g2.netlify.app/" target="_blank">
            Ver APP
          </a>
          <a
            href="https://github.com/DanielaDomh/ecommerce-academlo"
            target="_blank"
          >
            Ver Código
          </a>
        ...
        <div className="project-box">
          <div>
            ...
            <p>
              Apliación creada con REACT se utiliza Bootstrap, permite crear,
          ...
          <a href="https://github.com/DanielaDomh/crud-api" target="_blank">
            Ver Código
          </a>
        </div>
